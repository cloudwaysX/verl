...
from verl.utils.dataset import PretrainDataset, SFTDataset
...
class FSDPPretrainTrainer(object):
    ...
    def _build_model_optimizer(self):
        ...
        with init_context():
            # self.model: PreTrainedModel = AutoModelForCausalLM.from_config(local_model_path,
            #                                                                    config=config,
