...
PROJECT_NAME='mathamc'
EXPERIMENT_NAME='mathamc-s42-1.5b-2k_preselect3' 
...
python3 -m verl.trainer.main_ppo \
    ...
    +data.preselect="math_difficulty" \
    data.train_files=[$HOME/data/math/train.parquet,$HOME/data/amc/train.parquet] \
    ...
    active_strategy.greedy_top_percent=0.0 \
